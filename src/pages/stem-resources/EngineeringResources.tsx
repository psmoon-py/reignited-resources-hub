...
const EngineeringResources: React.FC = () => {
  const [searchTerm, setSearchTerm] = useState("");
  const [selectedDifficulty, setSelectedDifficulty] = useState("all");
  const [selectedSubcategory, setSelectedSubcategory] = useState("all");
  
  const allEngResources = getResourcesBySubject("engineering");
  
  // Filter resources based on search and filters
  const filteredResources = allEngResources.filter(resource => {
        ...
        <section className="bg-gradient-to-b from-orange-500/10 to-background pt-32 pb-16">
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl">
              ...
              >
                Engineering <span className="text-gradient-primary">Resources</span>
              </motion.h1>
              ...
              >
                Find mechanical, electrical, civil, chemical, aerospace, biomedical and environmental engineering resources for all levels.
              </motion.p>
              ...
              <div className="lg:col-span-1">
                <div className="bg-muted/10 rounded-lg p-6 sticky top-24">
                  ...
                  <div className="space-y-6">
                    <div>
                      <label className="text-sm font-medium mb-2 block">Engineering Discipline</label>
              ...
              <div className="lg:col-span-3">
                <div className="mb-8">
                  <h2 className="text-2xl font-bold mb-4">
                    {filteredResources.length} Engineering Resources
                  </h2>
                  ...
                  <Tabs defaultValue="all">
                    ...
                    <TabsContent value="simulations" className="mt-6">
                      <ResourceGrid resources={filteredResources.filter(r => 
                        r.tags.some(tag => 
                          ["simulation", "model", "CAD", "virtual", "demo"].includes(tag)
                        )
                      )} />
                    </TabsContent>
                    ...
                    <TabsContent value="references" className="mt-6">
                      <ResourceGrid resources={filteredResources.filter(r => 
                        r.type === "pdf" || r.type === "website" || r.type === "tool"
                      )} />
                    </TabsContent>
                  </Tabs>
                </div>
